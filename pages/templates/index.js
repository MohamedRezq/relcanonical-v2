                ...
                <div className="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                  <div className="d-flex align-items-center flex-wrap mr-1">
                    <div className="d-flex align-items-baseline flex-wrap mr-5">
                      <span className="text-dark-50 font-weight-bold my-1 mr-5 font-size-h5">Hello, <span className="text-dark font-weight-bolder font-size-h5">FName!</span></span>
                  ...
                  <div className="d-flex align-items-center">
                    <div className="">
                      <Link href={"https://relcanonical.gitbook.io/docs/templates/"}>
