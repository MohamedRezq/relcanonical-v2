        ...
        <div>
            ...
            <span>
                <Link rel="canonical" href={link}>
                    <a className="text-dark text-hover-dark-75 font-weight-bolder font-size-h4">
                        {card.pageName || ""}
                    </a>
                </Link>
            </span>
            ...
            <div className="card-body text-center px-15 py-20">
                <div className="mb-4">
                    <img src={solution.solutionIcon ? solution.solutionIcon : "https://ik.imagekit.io/kenefit/default_faq_image_i6mGVN1g6.jpg?updatedAt=1640423259316/"}
                        alt={solution.solutionName} className="rounded-circle" height="50" width="50" />
                </div>
                ...
                <div className="d-flex align-items-center">
                    <div className="mr-4">
                        <img src={question.questionAvatar ? question.questionAvatar : "https://ik.imagekit.io/kenefit/default_faq_image_i6mGVN1g6.jpg?updatedAt=1640423259316/"}
                            alt={question.questionDescriptor} className="rounded-circle" height="50" width="50" />
                    </div>
            ...
            <div className="card-body text-center px-15 py-20">
                <div className="mb-4">
                    <img src={references.referenceAvatar ? references.referenceAvatar : "https://ik.imagekit.io/kenefit/default_faq_image_i6mGVN1g6.jpg?updatedAt=1640423259316/"}
                        alt={references.referenceDescriptor ? references.referenceDescriptor : ""} className="rounded-circle" height="50" width="50" />
                </div>
                <div className="mt-4">
