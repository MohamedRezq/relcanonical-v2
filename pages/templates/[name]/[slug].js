        ...
        <div>
            <div className="mb-4 text-center">
                <Link href={"/templates/" + template.templateUrl}>
                    <a>
                        <img alt="Page Name" src={image ? image : "/assets/media/logos/logo_secondary_letter.png"} width="25" height="25px" />
                    </a>
                </Link>
            </div>
                        ...
                        pages.map(({ slugPageMainInfos }, index) => {
                            if (slugPageMainInfos[0].slugUrl !== "" && slugPageMainInfos[0].pageBreadcrumb !== "") {
                                return (
                                    <li className="breadcrumb-item font-weight-bolder text-muted">
                                        <a className="text-muted text-hover-primary"
                                            href={`${process.env.NEXT_PUBLIC_API}/templates/${template.templateUrl}/${slugPageMainInfos[0].slugUrl}`}>
            ...
            <div className="text-center">
                <Link href={"/templates/" + template.templateUrl}><a className="label label-light-primary label-inline font-weight-bolder">{template.templateName}</a></Link>
            </div>
        </div>
    )
}
...
function BenefitCard({ name, label, image }) {
    return (
        <div>
            <div className="card-body text-center">
                <div className="mb-4">
                    <img src={image ? image : "https://ik.imagekit.io/kenefit/default_faq_image_i6mGVN1g6.jpg?updatedAt=1640423259316/"}
                        alt={name} className="rounded-circle" height="50" width="50" />
                </div>
...
function PageCard({ card, media }) {
    return (
        <div>
            ...
            <span>
                <a rel="canonical" className="text-dark text-hover-dark-75 font-weight-bolder font-size-h4" href={card.slugUrl}>
                    {card.pageName || ""}
                </a>
            </span>
    ...
    return (
        <div>
            <div className="card-body text-center px-15 py-20">
                <div className="mb-4">
                    <img src={solution.solutionIcon ? solution.solutionIcon : "https://ik.imagekit.io/kenefit/default_faq_image_i6mGVN1g6.jpg?updatedAt=1640423259316/"}
        ...
        <div>
            <div className="card-body">
                ...
                <div className="d-flex align-items-center">
                    <div className="mr-4">
                        <img src={question.questionAvatar ? question.questionAvatar : "https://ik.imagekit.io/kenefit/default_faq_image_i6mGVN1g6.jpg?updatedAt=1640423259316/"}
                            alt="Benefit Name" className="rounded-circle" height="50" width="50" />
                    </div>
...
function ReferenceCard({ references, link }) {
    return (
        <div>
            <div className="card-body text-center px-15 py-20">
                <div className="mb-4">
                    <img src={references.referenceAvatar ? references.referenceAvatar : "https://ik.imagekit.io/kenefit/default_faq_image_i6mGVN1g6.jpg?updatedAt=1640423259316/"}
                        alt="Benefit Name" className="rounded-circle" height="50" width="50" />
                </div>
                <div className="mt-4">
...
const Slug = ({ templateName, slug, template }) => {
    ...
    const getPage = () => {
        for (let i = 0; i < template.slugPagesPer.length; i++)
            for (let j = 0; j < template.slugPagesPer[i].slugPage.length; j++) {
                if (template.slugPagesPer[i].slugPage[j].slugPageMainInfos[0].slugUrl == slug) {
                    setPageNum(i);
                    setSlugThisPage(template.slugPagesPer[i].slugPage[j]); break;
                }
            }
    }
    ...
    if (pageNum >= 0) {
        return (
            ...
            <div>
                ...
                <Head>
                    <title>{slugThisPage.slugPageMainInfos[0].pageTitle || ""} | {template.templateName || ""}</title>
                    <meta name="description" content={slugThisPage.slugPageMainInfos[0].pageDescription || ""} />
                </Head>
                        ...
                        <div className="container">
                            ...
                            <blockquote className="blockquote text-center mt-10">
                                <h2 className="mb-0 display-1 text-dark font-weight-boldest">
                                    {slugThisPage.slugPageMainInfos[0].pageName}
                                </h2>
                                <div className="my-6 font-weight-bold font-size-h4 text-dark-50 px-40">
                                    {slugThisPage.slugPageMainInfos[0].pageDescription}
                                </div>
                                                        ...
                                                        return (
                                                            <div className="col-xl-3 text-center">
                                                                <div className="card card-custom py-8 px-4 gutter-b">
                                                                    <BenefitCard name={benefitName} label={benefitLabel} link={slugThisPage.slugPageMainInfos[0].slugUrl} image={benefitIcon} />
                                                                </div>
                                                            </div>
                                                        )
                                                    }
                                                            ...
                                                            if (page.slugPageMainInfos[0].pageName.length > 0) {
                                                                return (
                                                                    <div className="col-xl-4 text-center">
                                                                        <PageCard card={page.slugPageMainInfos[0]} media={randomFun(page.slugPageMainInfos[0].pageMedia, 1)} />
                                                                    </div>
                                                                )
                                                            }
                                                        })
                                                        ...
                                                        return (
                                                            <div className="col-xl-4">
                                                                <div className="card card-custom gutter-b">
                                                                    <SolutionsCard solution={solution} link={slugThisPage.slugPageMainInfos[0].slugUrl} />
                                                                </div>
                                                            </div>
                                                        )
                                                    }
                                                    ...
                                                    if (value.referenceUser.length > 0) {
                                                        return (
                                                            <div className="col-xl-6">
                                                                <div className="card card-custom gutter-b">
                                                                    <ReferenceCard references={value} link={slugThisPage.slugPageMainInfos[0].slugUrl} />
                                                                </div>
                                                            </div>
                                                        )
                                                    }
                            ...
                            <div className="login-form login-signup">
                                <form className="">
                                    <div className="text-center pb-8">
                                        <Link href={"/"}>
                                            <a>
                                                <Image alt="Relcanonical" src="/assets/media/logos/logo_primary_letter.png" width="20" height="20px" />
                                            </a>
                                        </Link>
                                    </div>
                                    <div className="pb-4">
